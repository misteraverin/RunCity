...
/**
 * Created by Averin Maxim on 20.12.2016.
 */
...
public class CircleCountDownView extends FrameLayout {
    ...
    public void setProgress(int startTime, int endTime) {
        ...
        String timeLeft = (String.format("%02d", elapsedTime / 60) + ":" + String.format("%02d", elapsedTime % 60));
        progressTextView.setText(timeLeft);
    }
}
